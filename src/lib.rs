...
//! The simplest way is to use [`ParseExt::err_into`].
//!
//! ```
...
//! ```
//!
//! When relying on a [`From`] implementation doesn't work [`ParseExt::map_err`] and
//! [`ParseExt::map_res`] are also available to define error conversions separately for
//! each instance.
//!
//! # Features
...
///
/// An [`ErrorSeed`] is generally used in fallible combinators (i.e. any `ParseExt::try_*`
...
c0nst::c0nst! {
    ...
    pub c0nst trait ParseExt<I: Input>: Parse<I> {
    ...
    c0nst impl<P, I> ParseExt<I> for P
    where
        P: Parse<I>,
        I: Input,
    {
